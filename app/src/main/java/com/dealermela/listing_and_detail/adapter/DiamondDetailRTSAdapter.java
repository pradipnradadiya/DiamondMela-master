...
public class DiamondDetailRTSAdapter extends RecyclerView.Adapter<DiamondDetailRTSAdapter.ViewHolder> {
    private final Activity activity;
    private final List<RTSItem.Diamonddetail> itemArrayList;
    public static String diamondValue = "SI-IJ";

    public DiamondDetailRTSAdapter(Activity activity, List<RTSItem.Diamonddetail> itemArrayList) {
        super();
